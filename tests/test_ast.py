                ...
                f.write(
                    "\n".join(
                        [
                            ...
                            "@parameter('data_element_ids', name='Data Elements id', type=str, widget=ParameterWidgets.DHIS2_ORG_UNIT, connection='dhis_con', required=True)",
                            "@pipeline('Test pipeline')",
                            "def test_pipeline():",
                            "    pass",
                            "",
                ...
                pipeline.to_dict(),
                {
                    ...
                    "parameters": [
                        ...
                        },
                        {
                            ...
                            "widget": ParameterWidgets.DHIS2_ORG_UNIT.value,
                            "connection": "dhis_con",
                            "default": None,
                            "multiple": False,
                            "choices": None,
                ...
                f.write(
                    "\n".join(
                        [
                            ...
                            "@parameter('dhis_con', name='DHIS2 Connection', type=DHIS2Connection, required=True)",
                            "@pipeline('Test pipeline')",
                            "@parameter('data_element_ids', name='Data Elements id', type=str, widget=ParameterWidgets.DHIS2_ORG_UNIT, connection='sds_con', required=True)",
                            "def test_pipeline():",
                            "    pass",
                            "",
                        ]
                ...
                f.write(
                    "\n".join(
                        [
                            ...
                            "from openhexa.sdk.pipelines.parameter import ParameterWidgets",
                            "",
                            "@parameter('test_field_for_widget', name='Widget Param', type=str, widget=ParameterWidgets.DHIS2_ORG_UNIT, help='Param help')",
                            "@pipeline('Test pipeline')",
                            "def test_pipeline():",
                            "    pass",
                            "",
