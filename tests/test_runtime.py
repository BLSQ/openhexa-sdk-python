...
class RuntimeTest(TestCase):
    def test_get_pipeline_simple_pipeline_specs(self):
        for strategy in STRATEGIES:
            pipeline_specs = get_pipeline_specs(SIMPLE_PIPELINE, strategy)
    ...
    def test_get_pipeline_with_parameters_specs(self):
        for strategy in STRATEGIES:
            pipeline_specs = get_pipeline_specs(PIPELINE_WITH_PARAMETERS, strategy)
...
if __name__ == "__main__":
    pipeline_with_parameters()
        ...
        with self.assertRaises(PipelineNotFound):
            get_pipeline_specs(pipeline_content, "ast")  # TODO: check if relevant with import too
...
if __name__ == "__main__":
    ...
    """
        ...
        pipeline_specs = get_pipeline_specs(pipeline_content, "ast")  # TODO: check if relevant with import too
