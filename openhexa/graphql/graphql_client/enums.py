...
class CreateAssistantConversationError(str, Enum):
    INVALID_INSTRUCTION_SET = "INVALID_INSTRUCTION_SET"
    INVALID_LINKED_OBJECT_TYPE = "INVALID_LINKED_OBJECT_TYPE"
...
class UpdateWebappError(str, Enum):
    ...
    SUBDOMAIN_HAS_DOTS = "SUBDOMAIN_HAS_DOTS"
    SUBDOMAIN_INVALID_FORMAT = "SUBDOMAIN_INVALID_FORMAT"
    SUBDOMAIN_NOT_LOWERCASE = "SUBDOMAIN_NOT_LOWERCASE"
    SUBDOMAIN_REQUIRED = "SUBDOMAIN_REQUIRED"
    SUBDOMAIN_RESERVED = "SUBDOMAIN_RESERVED"
    SUBDOMAIN_TOO_SHORT = "SUBDOMAIN_TOO_SHORT"
    SUPERSET_INSTANCE_NOT_FOUND = "SUPERSET_INSTANCE_NOT_FOUND"
    SUPERSET_NOT_CONFIGURED = "SUPERSET_NOT_CONFIGURED"
...
class WebappOperationScope(str, Enum):
    DATASETS_READ = "DATASETS_READ"
    DATASETS_WRITE = "DATASETS_WRITE"
    FILES_READ = "FILES_READ"
    FILES_WRITE = "FILES_WRITE"
    PIPELINES_READ = "PIPELINES_READ"
