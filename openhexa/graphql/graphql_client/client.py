...
class Client(BaseClient):
    def get_workspace_pipelines(
        ...
        **kwargs: Any,
        ...
        response = self.execute(query=query, operation_name="getWorkspacePipelines", variables=variables, **kwargs)
    ...
    def get_countries(self, workspace_slug: str, **kwargs: Any) -> GetCountries:
        ...
        response = self.execute(query=query, operation_name="getCountries", variables=variables, **kwargs)
        data = self.get_data(response)
