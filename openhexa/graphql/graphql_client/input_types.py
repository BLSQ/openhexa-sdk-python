...
class RunPipelineInput(BaseModel):
    ...
    id: Any
    send_mail_notifications: Optional[bool] = Field(alias="sendMailNotifications", default=None)
...
class UpdateAccessmodAccessibilityAnalysisInput(BaseModel):
    ...
    health_facilities_id: Optional[str] = Field(alias="healthFacilitiesId", default=None)
    id: str
    ...
    transport_network_id: Optional[str] = Field(alias="transportNetworkId", default=None)
