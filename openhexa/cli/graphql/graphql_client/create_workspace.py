...
from .enums import ConnectionType, CreateWorkspaceError
...
class CreateWorkspaceCreateWorkspaceWorkspace(BaseModel):
    bucket: "CreateWorkspaceCreateWorkspaceWorkspaceBucket"
    connections: List["CreateWorkspaceCreateWorkspaceWorkspaceConnections"]
    countries: List["CreateWorkspaceCreateWorkspaceWorkspaceCountries"]
    created_at: Any = Field(alias="createdAt")
    created_by: "CreateWorkspaceCreateWorkspaceWorkspaceCreatedBy" = Field(
        alias="createdBy"
    )
    datasets: "CreateWorkspaceCreateWorkspaceWorkspaceDatasets"
    description: Optional[str]
    docker_image: Optional[str] = Field(alias="dockerImage")
    invitations: "CreateWorkspaceCreateWorkspaceWorkspaceInvitations"
    members: "CreateWorkspaceCreateWorkspaceWorkspaceMembers"
    name: str
    permissions: "CreateWorkspaceCreateWorkspaceWorkspacePermissions"
    slug: str
    updated_at: Optional[Any] = Field(alias="updatedAt")


class CreateWorkspaceCreateWorkspaceWorkspaceBucket(BaseModel):
    name: str


class CreateWorkspaceCreateWorkspaceWorkspaceConnections(BaseModel):
    typename__: Literal[
        "Connection",
        "CustomConnection",
        "DHIS2Connection",
...
class CreateWorkspaceCreateWorkspaceWorkspaceCreatedBy(BaseModel):
...
class CreateWorkspaceCreateWorkspaceWorkspaceDatasets(BaseModel):
    page_number: int = Field(alias="pageNumber")
    total_items: int = Field(alias="totalItems")
    total_pages: int = Field(alias="totalPages")


class CreateWorkspaceCreateWorkspaceWorkspaceInvitations(BaseModel):
    page_number: int = Field(alias="pageNumber")
    total_items: int = Field(alias="totalItems")
    total_pages: int = Field(alias="totalPages")


class CreateWorkspaceCreateWorkspaceWorkspaceMembers(BaseModel):
    page_number: int = Field(alias="pageNumber")
    total_items: int = Field(alias="totalItems")
    total_pages: int = Field(alias="totalPages")


class CreateWorkspaceCreateWorkspaceWorkspacePermissions(BaseModel):
